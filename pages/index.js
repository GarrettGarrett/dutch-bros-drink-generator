...
const cards =[
  {category: "Featured Drinks", description: "Featured", image: "/images/Featured.png"},
  {category: "Dutch Classics", description: "Our favorites, guaranteed to satisfy", image: "/images/Classics.png"},
  {category: "Cold Brew", description: "Cold Brew to fuel your day.  Also available Nitro-infused if you need an extra kick.", image: "/images/Coldbrew.png"},
  {category: "Dutch Freeze", description: "Blended coffee perfection, paired with your favorite flavor.", image: "/images/Dutchfreeze.png"},
  {category: "Americano", description: "Hand-pulled espresso shots of our dutch bros private reserve coffee blend.", image: "/images/Americano.png"},
  {category: "Dutch Bros Rebel Energy Drink", description: "An energy drink created by dutch bros, customized by you. Also available in sugar free!", image: "/images/Rebel.png"},
  {category: "Dutch Frost", description: "A dutch take on a classic shake.", image: "/images/Dutchfrost.png"},
  {category: "Tea", description: "High-quality organic green or paris black tea infused with any flavor.", image: "/images/Tea.png"},
  {category: "Kids", description: "Crafted for the kiddos - dutch frosts, smoothies, sodas and not-so-hots.", image: "/images/Kids.png"},
  {category: "Smoothie", description: "Our fruit smoothie crafted in your favorite flavors.", image: "/images/Smoothie.png"},
  {category: "Lemonade", description: "A sweet and tart way to refresh your day.", image: "/images/Lemonade.png"},
  {category: "Dutch Soda", description: "Sparkling soda water infused with your favorite flavor combo.", image: "/images/Dutchsoda.png"},
  {category: "Chai", description: "Chai it your way! Try it hot or iced!", image: "/images/Chai.png"},
  {category: "Dutch Cocoa", description: "Our exclusive chocolate milk, steamed to perfection with a flavor of your choice.", image: "/images/Dutchcocoa.png"},
]
...
useEffect(() => {
  setButtonText(`${selectedCategory?.length > 0 ? "Random " + selectedCategory.replace(
    "Dutch Bros Rebel Energy", "Rebel"
  ) : "Randomize"}`)
}, [selectedCategory])
...
function getRandomDrink(allDrinks, category=null){
  ...
  if (category == null) { //no category given, choose random without category
    return randomDrink
  }
  else {
